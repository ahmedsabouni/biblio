...
\DeclareUnicodeCharacter{0302}{\^{e}}

\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage{csquotes}
% set today to french format
...
\fancyhead{}
% add chapter name 
\fancyhead[L]{SABOUNI Ahmed} %%% CHANGE AS APPROPRIATE (you may need to use a shortened form of the title)
\fancyhead[R]{\today} %%% CHANGE AS APPROPRIATE
...
\input{Chapter2}
% prevent page break after chapter 2
\begingroup
\let\clearpage\relax
\addvspace{1.2cm}
\input{Chapter3}
...
% deactivate clearpage relaxation
